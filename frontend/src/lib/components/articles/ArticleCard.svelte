...
>
	...
	<div class="absolute top-2 right-2" title={article.is_read ? "Marqué comme lu" : "Marquer comme lu"}>
		{#if article.is_read}
		...
		{:else}
			<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5 text-gray-500 hover:text-gray-300">
	...
	<h3 class="text-left text-lg font-bold text-white pr-8">
